...
public class Node {
    ...
    private String lastList;   //Lista a volver si se bloquea

    public Node(int id, int timeIn, int raf, String lastList) {
    ...
    public Node clone() {
        ...
        Node newNode = new Node(this.id, this.timeIn, this.raf, this.lastList);
